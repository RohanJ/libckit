 ...
 * @purpose		: Thread Safe Dictionary Library implemented over a binary tree
 ******************************************************************************/

#define _GNU_SOURCE //MUST HAVE THIS because it makes use of GNU only 
                    //functions such as tdestroy which is not available
                    //on POSIX systems (including Mac OS X) in general
#include <search.h>
#include <stdlib.h>
#include <string.h>
#include <pthread.h>
